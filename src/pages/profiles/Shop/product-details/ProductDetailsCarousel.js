...
export default function ProductDetailsCarousel({ currentProduct }) {
  ...
  const settings2 = {
    ...
    variableWidth: true,
    centerPadding: '0px',
    slidesToShow: currentProduct.images.length > 3 ? 3 : currentProduct.images.length
  };
    ...
    <RootStyle>
      <Box sx={{ p: 1 }}>
        ...
        >
          ...
          <CarouselControlsArrowsIndex
            index={currentIndex}
            total={currentProduct.images.length}
            onNext={handleNext}
      ...
      <Box
        sx={{
          ...
          ...(currentProduct.images.length === 1 && { maxWidth: THUMB_SIZE * 1 + 16 }),
          ...(currentProduct.images.length === 2 && { maxWidth: THUMB_SIZE * 2 + 32 }),
          ...(currentProduct.images.length === 3 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(currentProduct.images.length === 4 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(currentProduct.images.length >= 5 && { maxWidth: THUMB_SIZE * 6 }),
