...
export default function InvoiceDetails({ invoice, invoiceFrom }) {
      ...
      <Card sx={{ pt: 5, px: 5 }}>
        <Grid container>
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            <img
              alt="logo"
              src="https://res.cloudinary.com/imran6099/image/upload/v1647157847/Final_hawfop.png"
              style={{ maxWidth: 120 }}
            />
          </Grid>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            ...
            <Typography variant="body2">{refTo?.name}</Typography>
            <Typography variant="body2">{refTo?.address}</Typography>
            <Typography variant="body2">Phone: {refTo?.phone}</Typography>
          </Grid>
