  ...
  return (
    <Card sx={{ display: 'flex', alignItems: 'center', p: 3 }}>
      <Box sx={{ flexGrow: 1 }}>
        ...
        <Typography variant="h3">{fNumber(TOTAL_CATEGORIES)}</Typography>
      </Box>
      <Box sx={{ flexGrow: 1 }}>
        <Typography variant="subtitle2">Total Sub Categories</Typography>
        ...
        <Typography variant="h3">{fNumber(TOTAL_SUBCATEGORIES)}</Typography>
      </Box>
